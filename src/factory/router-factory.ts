import {RouteSegment} from "../model/route-segment";
import {SimpleRouteSegment} from "../parser/router-segment-parser";
...
export function parseRouteSignature(url: string): RouteSegment[] {
